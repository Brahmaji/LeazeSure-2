      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 lg:gap-12 mb-12">
          ...
          <div className="col-span-2">
            ...
            >
              <img 
                src="https://customer-assets.emergentagent.com/job_lease-trust/artifacts/70kl15kz_Shield%20Logo%20SVG.svg" 
        ...
        <div className="pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="font-body text-sm text-gray-500">
              © 2024 LeazeSure. All rights reserved.
            </p>
            <div className="flex items-center gap-6">
              <div className="flex items-center gap-2">
                ...
                <span className="font-body text-xs text-gray-500">Equifax Partner</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-[#0BFFC9]"></div>
                <span className="font-body text-xs text-gray-500">SOC 2 Compliant</span>
              </div>
            </div>
          </div>
        </div>
