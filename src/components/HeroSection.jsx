          ...
          <div className="text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              ...
              <Button
                ...
                onClick={() => document.getElementById('tenants')?.scrollIntoView({ behavior: 'smooth' })}>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <div className="flex items-center gap-2 text-sm text-[#475569]">
                ...
                <span className="font-body">Equifax </span>
              </div>
              <div className="flex items-center gap-2 text-sm text-[#475569]">
                <CheckCircle className="w-4 h-4 text-[#0009B3]" />
              ...
              <div className="bg-white rounded-b-xl shadow-2xl p-6 border border-gray-100">
                ...
                <div className="bg-gray-50 rounded-xl p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    { name: 'Income Updated', icon: FileCheck },
                    ...
                    <div key={index} className="flex items-center gap-3">
                        ...
                        <CheckCircle className="w-4 h-4 text-[#0009B3] ml-auto" />
                      </div>
                    )}
                  </div>
                </div>
