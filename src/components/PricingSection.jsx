...
const PricingSection = () => {
  const plans = [
    ...
    },
    {
      ...
      originalYearlyPrice: '$59.99/year',
    ...
    },
    {
      ...
      badge: 'Per Tenant',
      features: [
        'Unlimited tenant pre-screening',
            ...
            >
              ...
              <div className="mb-6">
                <div className="flex items-baseline gap-1">
                  ...
                  {plan.originalPrice && (
                    <span className="font-body text-sm text-[#475569] line-through ml-1">{plan.originalPrice}/mo</span>
                  )}
                </div>
                {plan.yearlyPrice && (
                  <div className="flex items-center gap-2 mt-1">
                    <span className="font-body text-sm text-[#0009B3] font-medium">or {plan.yearlyPrice}</span>
                    {plan.originalYearlyPrice && (
                      <span className="font-body text-xs text-[#475569] line-through">{plan.originalYearlyPrice}</span>
                    )}
                  </div>
                )}
              </div>
              ...
              <Button
                ...
                onClick={plan.cta === 'Get Early Access' ? () => document.getElementById('early-access')?.scrollIntoView({ behavior: 'smooth' }) : undefined}
              >
                {plan.cta}
              </Button>
            </div>
